...
{
    internal class IngredientLineRepo : IIngredientLineRepo
    {
        private readonly string _tableName = "IngredientLine";
        public IngredientLine Create(IngredientLine ingredientLine)
        {
            string sql = $"INSERT INTO {_tableName} (ingredient_id, quantity, measure, recipe_id) " +
        ...
        public IngredientLine Update(IngredientLine ingredientLineToUpdate)
        {
